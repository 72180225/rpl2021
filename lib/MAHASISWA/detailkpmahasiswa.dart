...
class DetailKpMahasiswa extends StatefulWidget {
  List list;
  int index;
  DetailKpMahasiswa({this.index,this.list});
  @override
  _DetailKpMahasiswaState createState() => _DetailKpMahasiswaState();
}

class _DetailKpMahasiswaState extends State<DetailKpMahasiswa> {
  void deleteData(){
