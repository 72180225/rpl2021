...
import 'package:rpl2021/pengajuanSK/editdatask.dart';
import 'package:rpl2021/pengajuanSK/listsk.dart';


class DetailSkMahasiswa extends StatefulWidget {
  List list;
  int index;
  DetailSkMahasiswa({this.index,this.list});
  @override
  _DetailSkMahasiswaState createState() => _DetailSkMahasiswaState();
}

class _DetailSkMahasiswaState extends State<DetailSkMahasiswa> {
  void deleteDataSk(){
          ...
          onPressed: (){
            ...
            Navigator.of(context).push(
              new MaterialPageRoute(
                  builder: (BuildContext context)=>new ListSk()
              )
            );
          },
        ),
          ...
          child: new Center(
            child: new Column(
              children: <Widget>[
                ...
                //         new MaterialPageRoute(
                //             builder: (BuildContext context)=>new EditDataSk(list: widget.list, index: widget.index,)
                //         ),
                //       ),
                //     ),
                //     new RaisedButton(
