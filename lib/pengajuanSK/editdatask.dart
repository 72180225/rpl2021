...
class EditDataSk extends StatefulWidget {
  final List list;
  final int index;
  EditDataSk({this.index,this.list});

  @override
  _EditDataSkState createState() => _EditDataSkState();
}

class _EditDataSkState extends State<EditDataSk> {
