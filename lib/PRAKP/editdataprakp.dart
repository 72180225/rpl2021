...
class EditDataPraKp extends StatefulWidget {
  final List list;
  final int index;
  EditDataPraKp({this.index,this.list});

  @override
  _EditDataPraKpState createState() => _EditDataPraKpState();
}

class _EditDataPraKpState extends State<EditDataPraKp> {
