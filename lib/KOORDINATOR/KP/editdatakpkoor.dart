...
class EditDataKpKoor extends StatefulWidget {
  final List list;
  final int index;
  EditDataKpKoor({this.index,this.list});

  @override
  _EditDataKpKoorState createState() => _EditDataKpKoorState();
}

class _EditDataKpKoorState extends State<EditDataKpKoor> {
