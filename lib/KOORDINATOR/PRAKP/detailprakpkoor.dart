...
import 'editdataprakpkoor.dart';

class DetailPraKpKoor extends StatefulWidget {
  List list;
  int index;
  DetailPraKpKoor({this.index,this.list});
  @override
  _DetailPraKpKoorState createState() => _DetailPraKpKoorState();
}

class _DetailPraKpKoorState extends State<DetailPraKpKoor> {
                  ...
                  children: <Widget>[
                    new RaisedButton(
                      ...
                      onPressed: ()=>Navigator.of(context).push(
                        new MaterialPageRoute(
                            builder: (BuildContext context)=>new EditDataPraKpKoor(list: widget.list, index: widget.index,)
                        ),
                      ),
                    ),
                    new RaisedButton(
