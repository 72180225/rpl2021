...
class ListPraKpKoor extends StatefulWidget {
  @override
  _ListPraKpKoorState createState() => _ListPraKpKoorState();
}



class _ListPraKpKoorState extends State<ListPraKpKoor> {
        ...
        return new Container(
          ...
          child: GestureDetector(
            onTap: ()=>Navigator.of(context).push(
                new MaterialPageRoute(
                    builder: (BuildContext context) => new DetailPraKpKoor(list: list,index: i,)
                )
            ),
            child: new Card(
              child: new ListTile(
